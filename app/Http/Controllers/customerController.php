    ...
    public function allcustomer(Request $request)
    {
        ...
        $datatables =  Datatables::of($customer)
            ...
            ->addColumn('action', function ($customer) {
                return '
                  <a href="#" class="editbtn" data-id="'.$customer->id.'" data-name="'.$customer->name.'" data-phonenumber="'.$customer->phonenumber.'" data-address="'.$customer->address.'" data-customercategory_id="'.$customer->customercategory_id.'" data-toggle="modal" data-target="#editmodal" ><i class="fa fa-pencil fa-2x" style="color:#8080ff" aria-hidden="true"></i> </a> |
