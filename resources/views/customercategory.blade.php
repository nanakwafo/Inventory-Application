    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        <div class="content-main">
            ...
            <div class="content-top">
                ...
                <div class="col-md-4 ">
                    ...
                    <div class="validation-system">
                        ...
                        <div class="validation-form">
                            ...
                            <form method="post" action="savecustomercategory">
                                {{csrf_field()}}
                                <div class="vali-form">
                                    <div class="col-md-12 form-group1">
                                        <label class="control-label">Customer Category Name</label>
                ...
                <div class="col-md-8 ">
                    <table class="table table-bordered " id="customercategory-table">
                        <thead>
                        <tr>
                ...
                <div class="modal fade" id="deletemodal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form action="deletecustomercategory" method="post">
                            <div class="modal-body">
...
<script>
    $(function() {
        $('#customercategory-table').DataTable({
            processing: true,
            serverSide: true,
            ajax: '{!! route('allcustomercategory') !!}',
            columns: [
