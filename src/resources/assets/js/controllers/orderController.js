...
$(document).ready(function () {
    ...
    $('#addnew').click(function () {
        ...
        var strToAdd = '<tr class="item">' +
            ...
            '<td><div class="form-group"><select name="store[]" class="form-control store"  >' + store + '</select> </div></td>' +
            '<td><div class="form-group"><input name="rate[]" class="form-control" type="text" readonly /> </div> </td> ' +
            '<td><div class="form-group"> <input name="quantity[]" class="form-control quantity"   type="text" /> </div> </td> ' +
